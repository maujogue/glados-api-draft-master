...
def test_add_room(client):
    response = client.post("/room", json={"name": "Bedroom"})
...
def test_edit_room(client, rooms):
    room_id = "00000000-0000-0000-0000-000000000001"  # Kitchen
    response = client.patch(f"/room/{room_id}", json={"name": "Updated Kitchen"})
...
def test_edit_room_name_conflict(client, rooms):
    room_id = "00000000-0000-0000-0000-000000000001"  # Kitchen
    response = client.patch(f"/room/{room_id}", json={"name": "Living Room"})
